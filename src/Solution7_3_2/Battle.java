...
public class Battle {
    ...
    public void run(){
        ...
        while (destroyed != n - 1){
            ...
            ((Fighter)fighter).attack(victim);  //Приведение к типу интерфейс. Сам интерфейс Fighter в скобках. Внешние скобки необходимы, так как у приведения низкий приоритет. Без внешних скобок Java хочет выполнить .attack(victim)
